...
#define MQTT_HOST            "qmrv7u3.mqtt.iot.bj.baidubce.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
...
#define MQTT_USER            "qmrv7u3/dht11_test" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "xt7pgi9wp25bh6t1" // you MQTT login password, same as above
