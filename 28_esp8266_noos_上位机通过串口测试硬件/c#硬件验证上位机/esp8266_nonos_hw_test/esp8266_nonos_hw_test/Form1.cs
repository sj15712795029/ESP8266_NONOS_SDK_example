...
namespace esp8266_nonos_hw_test
{
    public partial class Form1 : Form
    {
        ...
        string operate_dht11_start_update = "DHT11_START_UPDATE";
        string operate_dht11_stop_update = "DHT11_STOP_UPDATE";
        ...
        private void b_get_temphump_Click(object sender, EventArgs e)
        {
            json_construction_send(hw_func, operate_dht11_start_update, null, null, null, null, null, null);
        }

        private void b_stop_get_temp_hump_Click(object sender, EventArgs e)
        {
            json_construction_send(hw_func, operate_dht11_stop_update, null, null, null, null, null, null);
        }
