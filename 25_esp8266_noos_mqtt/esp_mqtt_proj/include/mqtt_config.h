...
#define MQTT_HOST            "i312dui.mqtt.iot.bj.baidubce.com" // the IP address or domain name of your MQTT server or MQTT broker ,such as "mqtt.yourdomain.com"
#define MQTT_PORT            1883    // the listening port of your MQTT server or MQTT broker
#define MQTT_CLIENT_ID        "ESP8266_15712795029"    // the ID of yourself, any string is OK,client would use this ID register itself to MQTT server
#define MQTT_USER            "i312dui/esp8266_mqtt_test" // your MQTT login name, if MQTT server allow anonymous login,any string is OK, otherwise, please input valid login name which you had registered
#define MQTT_PASS            "eL44j0fWPfEOVT1O" // you MQTT login password, same as above
#define STA_SSID "WIRELESS_LINK"    // your AP/router SSID to config your device networking
