...
uint8_t ICACHE_FLASH_ATTR hw_oled_init(void);
uint8_t ICACHE_FLASH_ATTR hw_oled_clear(void);
uint8_t ICACHE_FLASH_ATTR hw_oled_display_on(void);
uint8_t ICACHE_FLASH_ATTR hw_oled_display_off(void);
...
uint8_t ICACHE_FLASH_ATTR hw_oled_set_normal_display(void);
uint8_t ICACHE_FLASH_ATTR hw_oled_set_inverse_display(void);
